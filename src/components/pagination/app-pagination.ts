...
export class AppPagination extends LitElement {
    ...
    /* Sayı düğmeleri */
    .page-num { min-width:32px; height:32px; display:grid; place-items:center; color:#2b2b2b; }
    .page-num:hover { background:rgba(255,106,0,.1); }
    .page-num[aria-current="page"] {
      background: var(--color-primary, #ff6a00); color:#fff; font-weight:700;
    }
    ...
    .page-btn svg { width:18px; height:18px; color: var(--color-primary, #ff6a00); }
